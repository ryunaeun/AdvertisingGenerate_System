...
export default {
  ...
  methods: {
    ...
    async requestResetPassword() {
      try {
        const response = await axios.post('http://localhost:8080/api/request-reset-password', null, {
    ...
    async verifyResetCode() {
      ...
      try {
        const response = await axios.post("http://localhost:8080/api/verify-reset-code", {
    ...
    async resendVerificationCode() {
      try {
        const response = await axios.post('http://localhost:8080/api/resend-verification-code', null, {
          params: { email: this.modalEmail }
        });
        alert(response.data);
      } catch (error) {
