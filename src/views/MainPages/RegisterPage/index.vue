      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <h6>제1조 (목적)</h6>
            <p>본 약관은 ADVI(이하 "회사")가 제공하는 서비스의 이용조건 및 절차, 회사와 회원 간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.</p>
            
            <h6>제2조 (서비스의 제공 및 변경)</h6>
            <p>회사는 회원에게 다양한 온라인 서비스를 제공하며, 필요에 따라 서비스의 일부를 변경, 추가 또는 종료할 수 있습니다.</p>
            
            <h6>제3조 (회원 가입)</h6>
            <p>회원은 본 약관을 동의한 후 회사가 정한 절차에 따라 회원가입을 신청할 수 있으며, 회사는 이를 승인함으로써 서비스 이용계약이 성립됩니다.</p>
            
            <h6>제4조 (회원의 의무)</h6>
            <p>회원은 서비스 이용 시 다음 행위를 금지합니다:<br>
              - 타인의 개인정보 도용<br>
              - 서비스 내 허위 정보 등록<br>
              - 저작권 등 제3자의 권리를 침해하는 행위
            </p>
            
            <h6>제5조 (서비스 이용 제한 및 계약 해지)</h6>
            <p>회원이 본 약관을 위반하거나 서비스 운영에 방해가 되는 경우, 회사는 사전 통보 후 서비스 이용을 제한할 수 있습니다.</p>
          </div>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <p>ADVI는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경될 경우 사전 동의를 받습니다.</p>
            
            <h6>2. 수집하는 개인정보의 항목</h6>
            <p>- 필수 정보: 이름, 이메일, 전화번호, 비밀번호<br>
               - 선택 정보: 프로필 사진, 주소</p>
            
            <h6>3. 개인정보 보유 및 이용 기간</h6>
            <p>회사는 회원 탈퇴 후에도 법령에 따라 일정 기간 동안 정보를 보관할 수 있습니다.</p>
            
            <h6>4. 개인정보의 제3자 제공</h6>
            <p>회사는 원칙적으로 개인정보를 외부에 제공하지 않으며, 회원의 동의 없이 제3자에게 제공하지 않습니다.</p>
            
            <h6>5. 개인정보 보호 조치</h6>
            <p>회사는 개인정보 보호를 위하여 다양한 보안 기술과 관리적 조치를 시행합니다.</p>
          </div>
          <div class="modal-footer">
